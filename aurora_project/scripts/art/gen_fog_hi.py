# -*- coding: utf-8 -*-
"""img2img: деревня/кладбище в сильном тумане, denoise 0.62/0.68 — меньше оригинала."""
import base64
import io
import json
import os
...
EXPERIMENTS = [
    ("fogvillage", 0.62, 8801),
    ("fogvillage", 0.62, 8802),
    ("fogvillage", 0.68, 8801),
    ("fogcemetery", 0.62, 8901),
    ("fogcemetery", 0.62, 8902),
    ("fogcemetery", 0.68, 8901),
]
