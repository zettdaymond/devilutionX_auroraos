...
через фильтр ввода не случится) и посев машины обложки сразу в `Game`
(`GameCover::SetWindowReused()`): стартового фокус-блика нет, защита
`Starting` не нужна, сворачивание в плитку включает обложку сразу. Путь
