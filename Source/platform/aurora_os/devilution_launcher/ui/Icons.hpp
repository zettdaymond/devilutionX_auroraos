...
inline constexpr const char *Cog = "\xEF\x80\x93";           // U+F013
...
inline constexpr const char *ChevronLeft = "\xEF\x81\x93";   // U+F053
inline constexpr const char *ChevronRight = "\xEF\x81\x94";  // U+F054
