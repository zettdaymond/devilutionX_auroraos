...
void RunGameLoop(interface_mode uMsg)
{
	...
	while (gbRunGame) {
		...
		// (как у меню и видео; плитку показывает нативная обложка Lipstick).
		// Спим до события, проснутое возвращаем в очередь — его обработает
		// насос наверху цикла. Без этого цикл крутился вхолостую на ~90%
